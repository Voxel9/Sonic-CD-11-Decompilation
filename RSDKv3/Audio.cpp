...
int InitAudioPlayback()
{
    ...
    constexpr SDL_AudioFormat ogv_fmt = AUDIO_F32SYS;
#else
    constexpr SDL_AudioFormat ogv_fmt = AUDIO_F32SYS;
#endif
    ogv_stream = SDL_NewAudioStream(ogv_fmt, 2, 48000, audioDeviceFormat.format, audioDeviceFormat.channels, audioDeviceFormat.freq);
    if (!ogv_stream) {
